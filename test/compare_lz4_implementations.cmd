...
:run
call :echo %1 @ 64-bit
%~dp0\..\src\%PROJECT%\bin\x64\Release\%PROJECT%.exe compare_lz4_implementations.xml %FILES% 1024 %1
call :echo %1 @ 32-bit
%~dp0\..\src\%PROJECT%\bin\x86\Release\%PROJECT%.exe compare_lz4_implementations.xml %FILES% 1024 %1
exit /b
