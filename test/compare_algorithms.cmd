...
:run
call :echo %1 @ 64-bit
%~dp0\..\src\misc\%PROJECT%\bin\x64\Release\%PROJECT%.exe compare_algorithms.xml %FILES% 1024 %1
call :echo %1 @ 32-bit
%~dp0\..\src\misc\%PROJECT%\bin\x86\Release\%PROJECT%.exe compare_algorithms.xml %FILES% 1024 %1
exit /b
