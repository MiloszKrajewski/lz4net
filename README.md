...
| .NET Standard | Safe | be first person to try it (for a while, unsafe is not working, see [this](http://stackoverflow.com/questions/42597583/release-multiple-assemblies-in-single-net-core-package)) |
